...
client.on("message", (message) => {
   ...
   if (message.content.startsWith("#new")) {     /// DREAM
        ...
        if (!message.guild.roles.exists("name", "admin")) return message.channel.send(`لازم تسوي رتبة اسمها \`admin\` وتنطي البوت ادمنيتر حتا يقدر يسوي الرومات ويعدل برمشنات`);
